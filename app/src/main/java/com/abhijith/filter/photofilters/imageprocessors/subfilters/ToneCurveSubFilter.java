...
import com.abhijith.filter.photofilters.geometry.BezierSpline;
...
public class ToneCurveSubFilter implements SubFilter {
    ...
    public void setTag(Object tag) {
        com.abhijith.filter.photofilters.imageprocessors.subfilters.ToneCurveSubFilter.tag = (String) tag;
    }
}

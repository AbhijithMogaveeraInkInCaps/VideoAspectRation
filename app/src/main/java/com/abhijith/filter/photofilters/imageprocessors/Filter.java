package com.abhijith.filter.photofilters.imageprocessors;


import android.graphics.Bitmap;
import androidx.annotation.NonNull;
import com.abhijith.filter.photofilters.imageprocessors.subfilters.BrightnessSubFilter;
import com.abhijith.filter.photofilters.imageprocessors.subfilters.ColorOverlaySubFilter;
import com.abhijith.filter.photofilters.imageprocessors.subfilters.ContrastSubFilter;
import com.abhijith.filter.photofilters.imageprocessors.subfilters.SaturationSubFilter;
import com.abhijith.filter.photofilters.imageprocessors.subfilters.ToneCurveSubFilter;
import com.abhijith.filter.photofilters.imageprocessors.subfilters.VignetteSubFilter;
...
public class Filter {
    ...
    public Filter(com.abhijith.filter.photofilters.imageprocessors.Filter filter) {
